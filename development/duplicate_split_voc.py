...
train_dir = '/mnt/2tb/General/Anand/split_images/out_split/train/'  # Replace with the path to your train directory
test_dir = '/mnt/2tb/General/Anand/split_images/out_split/test/'  # Replace with the path to your test directory
val_dir = '/mnt/2tb/General/Anand/split_images/out_split/val/'  # Replace with the path to your val directory
...
data_dirs = ['/mnt/2tb/General/Anand/split_images/data_conversion_pipeline/VOCdevkit_train/', '/mnt/2tb/General/Anand/split_images/data_conversion_pipeline/VOCdevkit_test/', '/mnt/2tb/General/Anand/split_images/data_conversion_pipeline/VOCdevkit_val/']
output_dirs = ['/mnt/2tb/General/Anand/split_images/out_split/op/train/', '/mnt/2tb/General/Anand/split_images/out_split/op/test/', '/mnt/2tb/General/Anand/split_images/out_split/op/val/']
